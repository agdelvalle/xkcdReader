    ...
    function getComics(url) {
        ...
        .then(res => {
            ...
            if(latestNum == stripNumbers.length){
                ...
                nextThree = stripNumbers[stripNumbers.length];
...
nextButton.addEventListener('click', () => {
    getComics(`https://xkcd.vercel.app/?comic=${nextFour}`)
...
prevButton.addEventListener('click', () => {
    getComics(`https://xkcd.vercel.app/?comic=${nextTwo}`)
    if(displayStrips.value == 1){
        showOne()
    } else if(displayStrips.value == 3) {
        showThree()
...
randomButton.addEventListener('click', () => {
    randomNum();
    getComics(`https://xkcd.vercel.app/?comic=${randomPageNum}`);
    if(displayStrips.value == 1){
        showOne()
    } else if(displayStrips.value == 3) {
        showThree()
